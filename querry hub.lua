...
local Window = Rayfield:CreateWindow({
    Name = "Querry Hub (Owner)",
    Icon = 0,
    LoadingTitle = "Querry Hub (Owner)",
    ...
    KeySystem = true,
    KeySettings = {
       Title = "Querry's key system",
       Subtitle = "Key System",
       Note = "key: querry owner",
       FileName = "Key",
       SaveKey = false,
...
if L.vhsows then
	local debugtab = Window:CreateTab("Debug", 7743876054)
		...
		debugtab:CreateSection("Target")
			...
			local debugl = debugtab:CreateLabel("Hello, welcome to Querry Hub!")
...
Modules.DisplayMessage("Made by Tekzo", "16")
local Modules = {}
Modules.Services = {
    RunService = game:GetService("RunService"),
    StarterGui = game:GetService("StarterGui")
